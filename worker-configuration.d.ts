/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0419904b7ac3243b425a28ac8b325d9d)
// Runtime types generated with workerd@1.20250525.0 2025-06-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_USERNAME: "admin";
		AUTH_PASSWORD: "change-this-password";
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").SupabaseMCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_USERNAME" | "AUTH_PASSWORD">> {}
}
